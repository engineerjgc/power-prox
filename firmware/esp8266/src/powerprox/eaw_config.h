#define HOST_NAME                     "PowerProxyModule"


/* Uncomment this out to enable debug prints if not connected to Arduino */
...
#ifndef ESP_WM_LITE_DEBUG_OUTPUT
...
#define AP_SSID                       "PowerProxyModuleAP"
#define AP_PWD                        "ThisIsThePassword"
